...
function ConversorDeMoedas() {
  ...
  useEffect(() => {
    fetch('http://api.exchangeratesapi.io/v1/latest?access_key=770108ef3d28644aa67186cf3b229f41&format=1')
  ...
  const converterMoeda = () => {
    fetch(`http://api.exchangeratesapi.io/v1/latest?access_key=770108ef3d28644aa67186cf3b229f41&format=1base=${deMoeda}&symbols=${paraMoeda}`)
      .then(response => response.json())
      .then(data => {
